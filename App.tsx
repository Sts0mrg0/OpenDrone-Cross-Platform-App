...
import { createBottomTabNavigator, createAppContainer, createStackNavigator, createNavigator } from "react-navigation";
import { fromLeft, zoomIn, fromBottom, fromRight, fromTop } from "react-navigation-transitions";
...
import FlightplanMap from "./src/screens/FlightplanMap";
...
const handleCustomTransitionStackNav = ({ scenes }) => {
  ...
  if (prevScene && prevScene.route.routeName === "Tabbar" && nextScene.route.routeName === "FlightplanDetails") {
